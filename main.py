...
# Students
student_1 = Student('Аль', 'Пачино', 'Муж')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ["Введение в програмирование"]

student_2 = Student('Сальма', 'Хайек', 'Жен')
...
lecturer_2 = Lecturer('Стивен', 'КИнг')
lecturer_2.courses_attached += ['Python']

# Reviewers
reviewer_1 = Reviewer('Джон', 'Уик')
reviewer_1.courses_attached += ['Python']

reviewer_2 = Reviewer('Сережка', 'Писарчук')
